export const smartphonesForMainScreen = [
    ...
    },
    {
        ...
        name: 'Samsung',
        subName: 'S10',
        description: 'В отличии от S9 — крупнее дисплей, при практически тех же габаритах, но убран 3D Touch. Лучше камера (улучшены алгоритмы + матрица). Фронтальная камера снимает видео 2160р (у предшественника 1440р). Более емкий аккумулятор (3400 мАч против 3000 мАч)'
    },
    {
        id: 3,
        ...
        name: 'Huawei',
        subName: 'P40',
        description: 'Дисплей с двумя режимами работы (переключение на более низкое разрешение для экономии заряда). Оптика камеры от Leica.\n' +
