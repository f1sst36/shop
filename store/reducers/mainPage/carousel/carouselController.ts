...
class CarouselController {
    ...
    public classNameForCardByIndex = (currentCardIndex: number, cardIndex: number, itemsCount: number, styles: any): string => {
        ...
        if (cardIndex === this.prevCardIndex(this.prevCardIndex(currentCardIndex, itemsCount), itemsCount))
            return cx(styles.leftItem, styles.hiddenItem);
        if (cardIndex === this.nextCardIndex(this.nextCardIndex(currentCardIndex, itemsCount), itemsCount))
